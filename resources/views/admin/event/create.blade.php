                        ...
                        <div class="login-form">
                            <form action="{{ route('admin.event.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ old('date') }}" name="date" class="form-control @if($errors->has('date')) is-invalid @endif" placeholder="Укажите дату">
                                    @error('date')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('place') }}" name="place" class="form-control @if($errors->has('place')) is-invalid @endif" placeholder="Введите место проведения">
                                    @error('place')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('url') }}" name="url" class="form-control @if($errors->has('url')) is-invalid @endif" placeholder="Введите ссылку на покупку билетов">
                                    @error('url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" style="min-height: 100px; padding-top: 10px" class="form-control @if($errors->has('description')) is-invalid @endif" rows="3" placeholder="Введите описание мероприятия">{{ old('description') }}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
